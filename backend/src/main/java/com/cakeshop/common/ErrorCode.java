...
public enum ErrorCode {
    ...
    KMS_KEY_NOT_FOUND(5402, "加密机中无此密钥"),
    ...
    SECURE_FIELD_TAMPERED(5420, "安全输入被篡改"),
    SECURE_FIELD_REPLAY(5421, "安全输入重放"),
    SECURE_FIELD_EXPIRED(5422, "安全输入已过期"),
    SECURE_FIELD_INVALID(5423, "安全输入格式错误"),
    ...
    PAYMENT_PASSWORD_LOCKED(5433, "付款密码已锁定"),
    PAYMENT_PASSWORD_INCORRECT(5434, "付款密码错误"),
    SMS_CODE_FORMAT_ERROR(5440, "验证码格式错(必须 6 位数字)"),
    SMS_CODE_EXPIRED(5441, "验证码已过期"),
    ...
    SMS_DAILY_LIMIT(5447, "已达今日上限"),
    SECURE_CHANNEL_INVALID(5500, "安全通道无效"),
    SECURE_CHANNEL_HANDSHAKE_FAILED(5501, "通道握手失败"),
    SECURE_CHANNEL_KEY_EXPIRED(5502, "通道密钥过期"),
    SECURE_CHANNEL_SIGN_INVALID(5503, "通道签名无效"),
    SECURE_RISK_HIGH(5510, "高风险操作被拒绝"),
    SECURE_DEVICE_MISMATCH(5511, "设备不匹配"),
    SECURE_FINGERPRINT_INVALID(5512, "设备指纹无效"),
    SECURE_GEO_VIOLATION(5513, "地理位置越界"),
